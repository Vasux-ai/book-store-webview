...
const News = () => {
    ...
    return (
        <div className='relative'>
            <h2 className='text-3xl font-semibold mb-6 mt-8'>News & Events</h2>
                    ...
                    news.map((news, index) => (
                        <SwiperSlide key={index}>
                            <div className='flex flex-col sm:flex-row sm:justify-between items-center gap-12'>
                                <div className='py-4'>
                                    <Link to="/">
                                        <h3 className='text-1xl font-semibold hover:text-yellow-600 mb-3'>{news.title}</h3>
                                    </Link>
                                    <div className='w-10 h-[4px] bg-yellow-500 mb-5'></div>
